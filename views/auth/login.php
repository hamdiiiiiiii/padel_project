...
<head>
    ...
    <link rel="stylesheet" href="<?php echo defined('BASE_URL') ? BASE_URL : ''; ?>/css/login.css">
                    ...
                    <div class="auth-card-body">
                        ...
                        <form method="POST" action="">
                            ...
                            <div class="register-link">
                                ...
                                <a href="<?php echo defined('BASE_URL') ? BASE_URL : ''; ?>/register">Create Account</a>
                            </div>
                        </form>
                    </div>
                </div>
...
<div id="forgotPasswordModal" class="modal-overlay" style="display: none;">
    <div class="modal-container">
        ...
        <div class="modal-body">
            ...
            <form id="forgotPasswordForm" method="POST" action="<?php echo defined('BASE_URL') ? BASE_URL : ''; ?>/forgot-password.php">
                <div class="form-group">
